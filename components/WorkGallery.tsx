  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        {/* Text Details */}
        <div className={`order-2 ${index % 2 === 0 ? 'md:order-1' : 'md:order-2'} flex flex-col space-y-6`}>
           ...
           <h3 className="font-serif text-5xl md:text-7xl text-offwhite leading-none">
             {project.title}
           </h3>
        ...
        <div className={`order-1 ${index % 2 === 0 ? 'md:order-2' : 'md:order-1'} h-[400px] md:h-[600px] w-full overflow-hidden relative rounded-sm`}>
          <motion.div 
            style={{ y }}
